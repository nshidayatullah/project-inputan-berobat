...
export default function BerobatEdit({
    employee,
    visit,
    medicines,
    diagnoses,
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        rr: visit.rr?.toString() || "",
        temp: visit.temp?.toString() || "",
        spo2: visit.spo2?.toString() || "",
        action_status: visit.action_status || "",
        medicines: visit.medicines || ([] as MedicineEntry[]),
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(route("kunjungan.berobat.update", visit.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-4">
                    <Link
                        href={route("kunjungan.berobat.rekam-medis", {
